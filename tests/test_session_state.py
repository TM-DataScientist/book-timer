from modules.session_state import load_reading_history, save_form_state


def test_save_and_load_reading_history_sorts_latest_first_and_deduplicates(tmp_path):
    ...
    assert load_reading_history(state_path) == [
        {"session_date": "2026-04-01", "book_title": "Beta"},
        {"session_date": "2026-03-30", "book_title": "Alpha"},
        {"session_date": "2026-03-28", "book_title": "Gamma"},
    ]
...
def test_load_reading_history_ignores_non_list_values(tmp_path):
    state_path = tmp_path / "state.json"
